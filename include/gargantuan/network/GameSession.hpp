...
namespace gargantuan::network {
	...
	struct GameSessionMetrics {
		...
		std::uint64_t RelevanceRegionsVisited = 0;
		std::uint64_t RelevanceCandidates = 0;
		std::uint64_t RelevanceCandidateMembershipVisits = 0;
		std::uint64_t RelevanceCandidateDedupHits = 0;
		std::uint64_t SpatialRegionCount = 0;
		std::uint64_t SpatialMembershipCount = 0;
		std::uint64_t LargeSpatialObjectCount = 0;
		std::uint64_t SpatialMembershipMoves = 0;
		std::uint64_t SpatialSameRegionUpdates = 0;
		std::uint64_t SpatialRegionBucketsRemoved = 0;
		std::uint64_t SpatialPeakRegionOccupancy = 0;
