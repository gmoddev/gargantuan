...
function(GargantuanStageRuntimeFile Source RelativePath Category)
	...
	set_property(GLOBAL APPEND PROPERTY GARGANTUAN_RUNTIME_ENTRIES "${RelativePath}|${Category}")
endfunction()
...
get_property(GARGANTUAN_RUNTIME_ENTRIES GLOBAL PROPERTY GARGANTUAN_RUNTIME_ENTRIES)
list(SORT GARGANTUAN_RUNTIME_ENTRIES)
set(GARGANTUAN_MANIFEST_FILES "")
set(GARGANTUAN_SEPARATOR "")
foreach(GARGANTUAN_RUNTIME_ENTRY IN LISTS GARGANTUAN_RUNTIME_ENTRIES)
	string(REPLACE "|" ";" GARGANTUAN_RUNTIME_FIELDS "${GARGANTUAN_RUNTIME_ENTRY}")
	list(GET GARGANTUAN_RUNTIME_FIELDS 0 GARGANTUAN_RUNTIME_PATH)
	list(GET GARGANTUAN_RUNTIME_FIELDS 1 GARGANTUAN_RUNTIME_CATEGORY)
