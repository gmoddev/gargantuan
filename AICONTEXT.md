...
| Game networking | `devdocs/CurrentArchitecture/ProtocolInputHardening.md`, `NetworkingContracts.md`, `SimulatedTransport.md`, `NetworkSchedulerContract.md`, `NetworkingFoundationValidation.md`, `RealGameTransport.md`, `BasicClientReplication.md`, `CharacterNetworkingFoundation3C.md`, `CharacterNetworkingFoundation3D.md`, `CharacterReplicationFoundation3E.md`, `CharacterNetworkingFoundation3E1.md`, `CharacterNetworkingFoundation3F.md`, `CharacterNetworkingFoundation3G.md`, `CharacterReplicationFoundation3H.md`, `ReplicationFoundation3I.md`, `ReplicationFoundation3J.md`, and `SpatialRuntimeProjectionFoundation3K.md`, then `networking-architecture.mdx`; current foundations include a production scheduler, pinned GNS adapter, reliable structural replication with immutable revisioned per-object materialization templates, dependency-safe bounded structural admission with scheduler-accepted commit and peer fairness, bounded Remotes, batched authoritative Character prediction/reconciliation, subsystem-owned spatial runtime projections with generation-safe spaces and distinct semantic pose/cell-address types, bounded server-owned relevance/materialization, failure-atomic one-shot session ownership, peer-specific 20/10/5 Hz Character importance, and bounded age-aware fair publication with variable-rate presentation |
