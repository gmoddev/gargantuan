...
`collection-badge.png` is original generated artwork created for this sample
with OpenAI's built-in image-generation tool. The generation prompt was:

> A single luminous cyan crystal shard inside a simple dark navy circular
> medallion, rendered as a polished, readable square game icon with no text,
> logo, or watermark.

`collection-beacon.gltf` is an original minimal triangle mesh created for this
